...
// ============================================================
// lib/gemini-vision.js — Image analysis through Gemini Flash Lite
// ------------------------------------------------------------
// Model used: config.GEMINI_VISION_MODEL
// Takes a base64 image + prompt, returns text (often JSON when
// responseMimeType is set).
// ============================================================
