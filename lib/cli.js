...
// ============================================================
// lib/cli.js — Command-line helpers
// ------------------------------------------------------------
//   - getFlag()  : read flags --foo / --foo=val / --foo val
//   - confirm()  : y/N prompt (auto-yes when --yes is passed)
...
function confirm(question, defaultNo = true) {
  ...
  return new Promise(resolve => {
    ...
    rl.question(`${question} ${suffix} > `, ans => {
      ...
      if (defaultNo) resolve(a === 'y' || a === 'yes');
      else resolve(!(a === 'n' || a === 'no'));
    });
  });
}
